...
```bash
git remote add encore encore://explain-the-news-app-8mc2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/explain-the-news-app-8mc2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/explain-the-news-app-8mc2/settings/integrations/github)
