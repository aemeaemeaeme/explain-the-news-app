 ...
 */
import { analyze as api_news_analyze_analyze } from "~backend/news/analyze";
import { contact as api_news_contact_contact } from "~backend/news/contact";
import { explain as api_news_explain_unified_explain } from "~backend/news/explain_unified";
import { fetchArticle as api_news_fetch_fetchArticle } from "~backend/news/fetch";
import { getArticle as api_news_get_getArticle } from "~backend/news/get";
import { ogImage as api_news_og_ogImage } from "~backend/news/og";
import { process as api_news_process_process } from "~backend/news/process";
import {
    testBothProviders as api_news_test_gemini_testBothProviders,
    testGemini as api_news_test_gemini_testGemini
} from "~backend/news/test_gemini";
...
export namespace news {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.ogImage = this.ogImage.bind(this)
            this.process = this.process.bind(this)
            this.testBothProviders = this.testBothProviders.bind(this)
        ...
        public async analyze(params: RequestType<typeof api_news_analyze_analyze>): Promise<ResponseType<typeof api_news_analyze_analyze>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_news_analyze_analyze>
        }

        public async contact(params: RequestType<typeof api_news_contact_contact>): Promise<ResponseType<typeof api_news_contact_contact>> {
            // Now make the actual call to the API
        ...
        public async fetchArticle(params: RequestType<typeof api_news_fetch_fetchArticle>): Promise<ResponseType<typeof api_news_fetch_fetchArticle>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_news_fetch_fetchArticle>
        }

        /**
         * ---------------- Endpoint ----------------
         */
        public async getArticle(params: { id: string }): Promise<ResponseType<typeof api_news_get_getArticle>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/article/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_news_get_getArticle>
        }
        ...
        public async ogImage(params: { id: string }): Promise<ResponseType<typeof api_news_og_ogImage>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/og/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_news_og_ogImage>
        }
        ...
        public async process(params: RequestType<typeof api_news_process_process>): Promise<ResponseType<typeof api_news_process_process>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/article/process`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_news_process_process>
        }

        /**
         * Test both OpenAI and Gemini in sequence
         */
        public async testBothProviders(params: RequestType<typeof api_news_test_gemini_testBothProviders>): Promise<void> {
            await this.baseClient.callTypedAPI(`/test/both-llms`, {method: "POST", body: JSON.stringify(params)})
        }

        /**
         * Test the Gemini API integration specifically
         */
        public async testGemini(params: RequestType<typeof api_news_test_gemini_testGemini>): Promise<void> {
            await this.baseClient.callTypedAPI(`/test/gemini`, {method: "POST", body: JSON.stringify(params)})
        }
    }
}
