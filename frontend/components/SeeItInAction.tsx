// frontend/components/SeeItInAction.tsx
  ...
  return (
    <section className="py-20 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Demo Article Card */}
        <div className="bg-white rounded-xl card-shadow p-8 md:p-12 max-w-4xl mx-auto">
          {/* Meta row */}
          <div className="flex flex-wrap items-center gap-2 text-sm mb-4 text-gray-700">
            <div className="flex items-center gap-1 chip-mist px-2 py-1 rounded">
          ...
          <div className="mb-6">
            <span className="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-xs font-medium">
              Gemini • {demoAnalysis.meta.model}
            </span>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <BiasBar
                  ...
                  confidence={demoAnalysis.bias.confidence as any}
                />
              </div>
              <div>
        ...
        <div className="text-center mt-12">
          <a
            href="#"
            className="btn-sage px-8 py-4 font-semibold inline-block transition-all hover:translate-y-[-2px]"
            onClick={(e) => {
              e.preventDefault();
