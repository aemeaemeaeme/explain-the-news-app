...
export default function ExamplesPage() {
  const examples = [
    ...
    },
    {
      id: 'housing-crisis',
      meta: {
        title: "City Council Approves Affordable Housing Initiative Despite Developer Opposition",
        domain: "localcitynews.org",
        byline: "Jennifer Walsh",
        readingTime: 5
      },
      tldr: {
        headline: "Municipal government mandates affordable units in new developments",
        paragraphs: [
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-12">
          {examples.map((example, index) => (
            <div key={example.id} className="bg-white rounded-2xl card-shadow p-8">
              {/* Meta Row */}
              <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 mb-6">
                ...
                <div className="px-2 py-1 rounded text-xs font-medium" style={{backgroundColor: 'var(--sage)', color: 'var(--navy)'}}>
                  {example.tone}
                </div>
              </div>
        ...
        <div className="text-center mt-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Get the same detailed analysis for any news article. Just paste a link and see the story from all angles.
            </p>
            <a
              href="/"
