...
// ----- secrets you configured in the Encore console -----
export const FIRECRAWL_API_KEY = secret("FIRECRAWL_API_KEY");   // used by fetch.ts
// If you want access to these elsewhere, you can export them too:
// export const GEMINI_API_KEY = secret("GEMINI_API_KEY");
...
// Configuration summary for logging/diagnostics
export function getConfigSummary(): Record<string, any> {
  return {
    llm_provider: CONFIG.LLM_ORDER,
